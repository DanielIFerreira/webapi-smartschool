        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<Curso>()
                .HasData(new List<Curso>{
                    ...
                    new Curso(3, "Ciência da Conputação"),
                });
            ...
            builder.Entity<Disciplina>()
                .HasData(new List<Disciplina>{
                    ...
                    new Disciplina(5, "Inglês", 4, 2),
                    new Disciplina(6, "Inglês", 4, 3),
                    new Disciplina(7, "Inglês", 5, 1),
            ...
            builder.Entity<Aluno>()
                .HasData(new List<Aluno>(){
                    new Aluno(1, 1, "Marta", "Kent", "33225555", DateTime.Now),
                    new Aluno(2, 2, "Paula", "Isabela", "3354288", DateTime.Now),
                    new Aluno(3, 3, "Laura", "Antonia", "55668899", DateTime.Now),
                    new Aluno(4, 4, "Luiza", "Maria", "6565659", DateTime.Now),
                    new Aluno(5, 5, "Lucas", "Machado", "565685415", DateTime.Now),
                    new Aluno(6, 6, "Pedro", "Alvares", "456454545", DateTime.Now),
                    new Aluno(7, 7, "Paulo", "José", "9874512", DateTime.Now)
                });
